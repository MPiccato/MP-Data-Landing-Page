            ...
            {isMobileMenuOpen && (
              <div className="mt-2 mx-2 md:hidden backdrop-blur-2xl bg-white/90 border border-white/50 rounded-2xl p-4 shadow-xl animate-fade-in-down">
                <nav className="flex flex-col space-y-4">
                  ...
                  <a href="#suscripciones" onClick={() => setIsMobileMenuOpen(false)} className="bg-[#0071e3] text-white text-center text-sm font-medium py-2 rounded-xl">Suscribirse</a>
                </nav>
              </div>
            )}
          </div>
        ...
        <footer id="contacto" className="bg-white border-t border-[#e5e5e7]">
          <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between text-md text-[#86868b] space-y-4 md:space-y-0">
            ...
            <div className="flex  md:mb-0 space-x-16">
              <a href="https://github.com/MPiccato" className="hover:text-[#0071e3] transition-colors">GitHub</a>
              <a href="https://x.com/mpiccato" className="hover:text-[#0071e3] transition-colors">X (Twitter)</a>
              <a href="https://www.facebook.com/profile.php?id=100057102174084" className="hover:text-[#0071e3] transition-colors">Facebook</a>
            </div>
          </div>
        </footer>
      </body>
